...
import { ShieldAlert, Check, Plus, Trash2, X, Save, Loader } from 'lucide-react';
...
export default function InternalTab({ venue }: InternalTabProps) {
        ...
        <div>
            ...
            {status && (
                <div style={{
                    ...
                    fontFamily: "'Montserrat', sans-serif",
                    background: status.type === 'success' ? '#22c55e' : '#ef4444', color: '#fff',
                    ...
                    <div className="checklist">
                        {verificationItems.map((item, i) => (
                            <div key={i} className="checklist-item" style={{ alignItems: 'flex-start', gap: 12, flexWrap: 'wrap' }}>
                                ...
                                >
                                    {item.value && <Check width={14} height={14} strokeWidth={3} />}
                                </div>
                                <span
            ...
            {/* Activity Timeline — static, driven by saved dates */}
            <section className="form-section">
                <div className="form-section-header">
                    <div>
